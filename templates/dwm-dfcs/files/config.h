...
static const Rule rules[] = {
    ...
    {  "st-256color",    "st-256color",     "tg",               1 << 5,             0,                   -1 },
};
...
/*screenshots*/
static const char *sscmd[] = { "dwm-screenshot", "-s",  NULL };
static const char *ssscmd[] = { "dwm-screenshot", "-m", NULL };

/*tabbed nnn*/
static const char *n3cmd[] = { "tabn3", NULL };

/*Brightness*/
static const char *brightup[] = { "brightness", "+", NULL };
static const char *brightdw[] = { "brightness", "-", NULL };

/*poweroff*/
static const char *pocmd[] = { "menu-apagar", NULL };
...
static Key keys[] = {
    ...
    {ControlMask,                   XK_Print,  spawn,          {.v = ssscmd } },
	{ControlMask|ShiftMask,			XK_n,	   spawn,          {.v = n3cmd } },
    {0,                             XF86XK_MonBrightnessUp,   spawn,  {.v = brightup } },
    {0,                             XF86XK_MonBrightnessDown, spawn,  {.v = brightdw } },
    {0,                             XF86XK_PowerOff,          spawn,  {.v = pocmd } },
    {0,                             XK_F1,                    spawn,  {.v = tgcmd } },
};
